...
try {
    ...
    let beginningHTML = '<article class="lawFacultyWrapper listwrapper col flex-fill my-3" id="listbio' + listDict.contentId.content + '" aria-label="' + listDict.firstName.content + ' ' + listDict.lastName.content + '">';
    ...
    let cardTitle = (listDict.biography.content) ?
        '<h3 class="card-title d-flex justify-content-center justify-content-md-start text-center text-md-start mt-0">\
                            <a class="card-link" target="_blank" href="' + listDict.fullTextLink.content + '" title="' + listDict.firstName.content + ' ' + listDict.lastName.content + ', ' + listDict.primaryTitle.content + '">\
