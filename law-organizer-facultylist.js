 ...
 */
 try {
    ...
    let beginningHTML = '<article class="lawFacultyWrapper listwrapper col flex-fill shadow mb-2" id="listbio' + listDict.contentId.content + '" aria-label="' + listDict.firstName.content + ' ' + listDict.lastName.content + '">';
